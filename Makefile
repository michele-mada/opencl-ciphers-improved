...
library: $(BIN_PATH)/$(LIB_NAME)
	...
	$(shell cp --parents ./src/ciphers/common/callbacks.h $(BIN_PATH)/include/)
	$(shell cp --parents ./src/ciphers/common/error.h $(BIN_PATH)/include/)
	$(shell cp --parents ./src/ciphers/common/primitives.h $(BIN_PATH)/include/)
